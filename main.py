...
Changelog;
    ...
    1. I have changed the way I ask the user about the file name
       by defining a yes_no_question function.
    2. Some slight formatting changes.
"""
__version__ = '1.3'
__maintainer__ = "jamiejackherer@gmail.com"
__status__ = "Deployment"
__updated__ = '09.06.2016'  # day.month.year
...
def get_vodlocker_link():
    ...
    link_id = df['title']
    #    results = df['num_results_for_query']   #XXX temp disable
    #    results_lower = str(results[0]).lower()
    # Print how many links found in how many secs    
    print("{0}\n|{1}[+] {2}We have found **disabled** \n{2}" \
          .format(lb, G, W)) #XXX need to put results_lower back
